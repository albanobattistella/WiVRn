...
void * video_encoder_vulkan_h264::encode_info_next(uint32_t frame_num, size_t slot, const std::vector<vk::VideoReferenceSlotInfoKHR> & ref_slots)
{
	slice_header = {
	        .flags =
	                {
...
decltype(video_encoder_vulkan_h264::video_profile_info) video_encoder_vulkan_h264::video_profile_info = vk::StructureChain{
